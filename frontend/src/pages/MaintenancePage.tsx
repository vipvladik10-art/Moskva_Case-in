  ...
  return (
    <div style={{ padding: 18 }}>
      ...
      {!isLoading && tasks.length === 0 && (
        <p className="muted">
          Нет открытых нарядов. Система автоматически создаёт задачи ТО для простаивающей техники
          при прогнозном риске осадков; демо-сценарий в правой панели только имитирует внезапное
          событие.
        </p>
      )}
